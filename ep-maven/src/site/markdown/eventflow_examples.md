...
4. Uses [test-java-fragment](https://tibcosoftware.github.io/tibco-streaming-maven-plugin/2.0.0-SNAPSHOT/ep-maven-plugin/test-java-fragment-mojo.html) to launch
...
6. Uses [package-eventflow-fragment](https://tibcosoftware.github.io/tibco-streaming-maven-plugin/2.0.0-SNAPSHOT/ep-maven-plugin/package-eventflow-fragment-mojo.html) to create
